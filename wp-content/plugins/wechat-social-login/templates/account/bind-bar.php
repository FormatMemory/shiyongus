  ...
  <?php if($channels){
		    ...
		    foreach ($channels as $channel){
                ...
                <div class="xh-form-group xh-mT20  xh-social clearfix">
                     <div class="xh-left"><span class="xh-text"><a href="javascript:void(0);" rel="noflow"  class="xh-social-item <?php echo $channel->svg?>" title="<?php echo esc_attr($channel->title);?>"></a> <?php echo $channel->title?></span></div>
