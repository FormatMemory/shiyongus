        ...
        <div class="on_thum b404">
          ...
          <?php
            if ( has_post_thumbnail() ) {
             ...
             echo '<'.( is_amp() ? 'amp-img layout="responsive"' : 'img' ).' src="'.esc_url(get_theme_mod( 'simple_days_404_img' , get_template_directory_uri() .'/assets/images/404.jpg')).'" width="960" height="640" />';
            } ?>
        </div>
