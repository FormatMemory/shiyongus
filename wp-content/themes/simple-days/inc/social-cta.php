...
<div class="s_d_cta_box simple_days_box_shadow">
  ...
  <<?php echo (is_amp()?'amp-img layout="responsive"':'img'); ?> src="<?php if ( has_post_thumbnail()) {echo esc_url(wp_get_attachment_url( get_post_thumbnail_id($post->ID) ));}else{echo esc_url(get_template_directory_uri() .'/assets/images/blank.png');} ?>" width="640" height="480">
  </div>
  <div class="cta_box_wrap">
    <div class="cta_box_thum fit_box_img_wrap">
      <<?php echo (is_amp()?'amp-img layout="responsive"':'img'); ?> src="<?php if ( has_post_thumbnail()) {echo esc_url(wp_get_attachment_url( get_post_thumbnail_id($post->ID) ));}else{echo esc_url(get_theme_mod( 'simple_days_no_img' , get_template_directory_uri() .'/assets/images/no_image.png'));} ?>" width="640" height="480"  />
    </div>
