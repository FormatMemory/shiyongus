        ...
        <meta itemprop="thumbnailUrl" content="<?php
              if(!has_post_thumbnail()) {
               ...
               if(isset($matches [1] [0])){
                 ...
                 echo esc_url(get_theme_mod( 'simple_days_no_img' , get_template_directory_uri() .'/assets/images/no_image.png'));
               }
             }else{
          ...
          <div itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
            ...
            if ( is_amp() ){
              if (get_theme_mod( 'simple_days_amp_logo_img') != ''){
                    ...
                    echo esc_url(get_template_directory_uri() .'/assets/images/amp-logo.png');
              }
            }else{
              if ( has_custom_logo() ){
                echo esc_url(wp_get_attachment_url( get_theme_mod( 'custom_logo' ) ));
