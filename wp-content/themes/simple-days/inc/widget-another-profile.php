...
public function scripts($hook){
  ...
  if ($hook == 'widgets.php' || $hook == 'customize.php') {
    ...
    wp_enqueue_media();
    wp_enqueue_script('simple_days_widget-uploader', get_template_directory_uri() . '/assets/js/customizer/widget-uploader.min.js', array('jquery'));
    wp_enqueue_style( 'wp-color-picker');
    wp_enqueue_script( 'wp-color-picker');

    if(is_customize_preview()){
      wp_enqueue_script('simple_days_widget-color-picker', get_template_directory_uri() . '/assets/js/customizer/color-picker-customizer.min.js', array('jquery'));
    }else{
      wp_enqueue_script('simple_days_widget-color-picker', get_template_directory_uri() . '/assets/js/customizer/color-picker-widget.min.js', array('jquery'));
    }
  }
}
