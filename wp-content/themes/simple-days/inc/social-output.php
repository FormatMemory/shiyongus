            ...
            case 'pinterest':
              ...
              if(!has_post_thumbnail()) {
                ...
                $imageurl = esc_url($matches [1] [0]);
                  ...
                  $imageurl = esc_url(get_theme_mod( 'simple_days_no_img' , get_template_directory_uri() .'/assets/images/no_image.png'));
                }
              }else{
