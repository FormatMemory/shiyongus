	        ...
	        if(strpos($match_url[2][$i],home_url()) !== false){
              ...
              if($post_id != '0'){
                ...
                if(!empty($thumurl)){
                  ...
                  $img_source = '<img src="'.esc_url(get_theme_mod( 'simple_days_no_img' , get_template_directory_uri() .'/assets/images/no_image.png'));
                }
