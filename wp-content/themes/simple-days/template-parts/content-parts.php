...
function simple_days_index_category($mod_value){
 ...
 if(!empty($category)){
   echo '<a href="' . esc_url(get_category_link( $category[0]->term_id )) . '" class="post_card_category opa7 non_hover">' . esc_html($category[0]->cat_name) . '</a>';
 }
}
function simple_days_index_date($mod_value){
 ...
 <div class="post_card_date">
   <div class="post_date_wrap">
     <div class="post_date_circle<?php echo esc_attr($mod_value['date_wrap']); ?>">
