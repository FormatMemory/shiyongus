...
?>
  ...
  <footer id="site_f">
    <?php if( has_nav_menu('secondary') && $mod == '1' ) simple_days_footer_menu(); ?>
    <aside class="f_widget_wrap">
      <div class="f_widget">
    ...
    <?php if( has_nav_menu('secondary') && $mod == '2' ) simple_days_footer_menu(); ?>
    ...
    <?php if( has_nav_menu('secondary') && $mod == '3' ) simple_days_footer_menu(); ?>
  </footer>
<?php wp_footer(); ?>
</body>
</html>
